...
<style lang="less">
    ...
    .little-buddha {
        ...
        position: relative;
        animation: buddha-translate 3s ease-in-out infinite;
        ...
        .head {
            ...
            tomato 0.6em,
            transparent 0.6em), /* circle between eyebrows */
            currentColor;
            border-radius: 50%;
        ...
        .shadow {
            ...
            animation: buddha-shadow 3s ease-in-out infinite;
        }
