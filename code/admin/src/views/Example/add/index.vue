        ...
        <div class="box">
            <el-form :model="info" :rules="rules" ref="form" label-width="100px" class="form">
                ...
                <el-form-item label="文件类型" prop="filetype">
                    ...
                    <el-alert class="form-tip" title="文件目录下的必须得有index.html" type="info" show-icon :closable="false" v-if="info.filetype === 'folder'"></el-alert>
                </el-form-item>
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate(async (valid) => {
                    ...
                    if (valid) {
                        ...
                        try {
                            await Example.addExample(this.info.filetype, formData)
                            this.loading = false
