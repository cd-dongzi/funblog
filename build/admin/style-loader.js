...
exports.cssLoader = function(opts) {
    ...
    let colorsLess = getLessVariables(path.join(__dirname, '../../static/admin/color.less'))
    let stylesLess = getLessVariables(path.join(__dirname, '../../static/admin/style.less'))

    let variables = Object.assign({},colorsLess, stylesLess)
    return {
        css: generateLoaders(),
